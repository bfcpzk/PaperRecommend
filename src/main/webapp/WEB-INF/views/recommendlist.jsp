...
<head>
    ...
    <style type="text/css">
        ...
        .feed_back {display: none; position: fixed; top: 10%; left: 30%;  width: 40%; z-index:1005; overflow: auto; overflow-y:scroll;}
    </style>
</head>
<body>
    <div class="container">
                ...
                <tbody id="tbody_content">
                    <c:forEach items="${paperList}" var="item">
                        <tr>
                            ...
                            <td id="count_${item.item_ut}">${item.page_count}</td>
                            <td id="cite_${item.item_ut}">${item.cited_count}</td>
                            <td id="time_${item.item_ut}">${item.publication_year}.${item.publication_date}</td>
                        </tr>
                        <tr>
                            <td>文章摘要:</td>
                            <td id="abstract_${item.item_ut}" colspan="5">${item.abs}</td>
                        </tr>
                        <tr style="margin-bottom:5px;">
                            <td>用户打分:</td>
                            <td id="action_${item.item_ut}" colspan="3">
                ...
                <tbody>
                    ...
                    <tr>
                        <td width="75%">
                            ...
                            <a style="margin-left: 5px" href="javascript:void(0)" onclick="chooseLength('正合适', '0.0')" class="btn btn-info">正合适</a>
                            <a style="margin-left: 5px" href="javascript:void(0)" onclick="chooseLength('再长一些', '0.05')" class="btn btn-warning">再长一些</a>
                        </td>
                    ...
                    <tr>
                        <td width="75%">
                            <a style="margin-left: 5px" href="javascript:void(0)" onclick="chooseCite('正合适', '0.0')" class="btn btn-info">正合适</a>
                            <a style="margin-left: 5px" href="javascript:void(0)" onclick="chooseCite('有待提高', '0.05')" class="btn btn-warning">有待提高</a>
                        </td>
